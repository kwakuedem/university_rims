    ...
    const submissions = [
        {
            ...
            text:
                ...
                "Facilis praesentium molestias tempore porro incidunt, aperiam accusamus \n" +
                "commodi error dolor, cum officia, nemo iusto dolorem eos ea eum recusandae modi tempora.",
...

        {
            ...
            text:
                ...
                "praesentium molestias tempore porro incidunt, aperiam accusamus commodi \n" +
                "error dolor, cum officia, nemo iusto dolorem eos ea eum recusandae modi tempora.",
            associate: "Ho University Association,2003",
            author: "O'Edem",
            date: "2024-04-02",
        },
                            ...
                            <div className="flex w-full lg:w-[70%] m-auto  bg-white ">
                                <div className="flex items-center gap-9">
                                    ...
                                    <div className="flex gap-3">
                                        <Link className="text-blue-900/80">
                                            Colleges & Schools
                                        </Link>
                                        <Link className="text-blue-900/80">
                                            Statistics
                                ...
                                <div className="search-div bg-white py-8">
                                    ...
                                    >
                                        <div className=" flex bg-green-400 justify-center rounded-md">
                                            <button className="px-2 text-lg text-white bg-red-600 rounded-l-md">
                                                All DSapce
                                            </button>
                                            <input
                                                type="text"
                                        ...
                                        {downloaded.map((download) => (
                                            ...
                                            >
                                                ...
                                                <Link
                                                    ...
                                                    className=" text-blue-900/90 font-bold"
                                                >
                                                    {download.title}{" "}
                                                ...
                                                <span className="bg-red-500/90 w-24 flex justify-center items-center gap-2 rounded-lg font-bold text-white">
                                                    <FaSearch />
                                                    <span>
                                                        {download.down}
                                                    </span>{" "}
